...
@Profile("control")
public class ControlExperimentRunnerController {

    private final ControlExperimentRunner experimentRunner;
    private final ExperimentRunResultStore resultStore;
    private final ExperimentCsvExporter csvExporter;

    public ControlExperimentRunnerController(
            ControlExperimentRunner experimentRunner,
